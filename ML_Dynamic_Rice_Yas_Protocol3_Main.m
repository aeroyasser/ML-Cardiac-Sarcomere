...
Ca_Ampl      = (0.80:0.025:1.5);%[0.85 0.95 1.05 1.15 1.25 1.45];%(0.80:0.05:1.5); %[0.85 0.95 1.05 1.15 1.25 1.45]; % maximum Ca [uM]
SLo_values   = 1.9;%(1.8:0.05:2.2);  % initial Sarcomere length (um)
K            = 1;%(1:5:50);     % Stiffness series elastic (norm Force/um)      
...
% Input parameters
%-----------------
Protocol=3;                   % 1 = Fig 5 , 2= Fig 7, 3= Fig6
...
% % -------------------------
% ML_Dynamic_Rice_Protocol3_Fig6=[Time_input; Temp_input; KSE_input; SLo_input; Ca_input; F_active_output; F_total_output; SL_output];
% csvwrite('ML_Dynm_Rice_Protocol3_Fig6.csv',ML_Dynamic_Rice_Protocol3_Fig6)
% %------------------------------

%------------------------------------------------
% Export Protocol1, Test#1 @ Temp= 22.5, KSE=1, SL0=1.9 & vary Camax 
%------------------------------------------------
ML_Dynamic_Rice_Protocol3_Test1_Fig6AB=[Time_input; Temp_input; KSE_input; SLo_input; Ca_input; F_active_output; F_total_output; SL_output];
csvwrite('ML_Dynm_Rice_Protocol3_Test1_Fig6AB.csv',ML_Dynamic_Rice_Protocol3_Test1_Fig6AB)
%------------------------------
