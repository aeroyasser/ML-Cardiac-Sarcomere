...
%-----------------------------------
% Protocole # 2 (Dynamic Twitch Data)
%-----------------------------------
%-----------------------------------
% Step 1: Load Training Data 1 
%-----------------------------------
data_1=readmatrix('ML_Dynm_Rice_Protocol2_Fig7.csv');  % import data [Time,Temp,Ca,SLo,KSE, Fact, Ftot SL]
...
net.trainParam.epochs=10;        % number of epoch
%-----------------------------------------
...
% Load Test#1 Data @ Temp= 22.5, vary KSE & Camax = 1.45, SL=2.2 
%------------------------------------------------------------------------------
Data_Test1=readmatrix('ML_Dynm_Rice_Protocol2_Test1_Fig7AB.csv');  % import data [Time,Temp,Ca,SLo,KSE, Fact, Ftot SL]
...
for i=200:200:1400
figure(10)
plot(Time(i-200+1:1:i),y_test1(1,i-200+1:1:i),'o');
hold on
plot(Time(i-200+1:1:i),Pred1(1,i-200+1:1:i),'g');


figure(11)
plot(Time(i-200+1:1:i),y_test1(3,i-200+1:1:i),'o');
hold on
plot(Time(i-200+1:1:i),Pred1(3,i-200+1:1:i),'g');
