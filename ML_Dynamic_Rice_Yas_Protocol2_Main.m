...
%--------------------------------
T            = 22.5;%(20:1:30);      % Temperature in (C)
Ca_Ampl      = 1.45;%(0.80:0.025:1.5); %[0.85 0.95 1.05 1.15 1.25 1.45]; % maximum Ca [uM]
SLo_values   = 2.2;%(1.8:0.05:2.3);  % initial Sarcomere length (um)
K            = [1 1.5 2 3 5 10 50];%linspace(1,50,10);%[1 1.5 2 3 5 10 50];  % Stiffness series elastic (norm Force/um)      
...
% Input parameters
%-----------------
Protocol=2;                   % 1 = Fig 5 , 2= Fig 7, 3= Fig6
Animal = 2;                   % ( = 1 ) for "rat" ,and  ( = 2)for "rabbit" 
Cell_type =1;                 % ( = 1 ) for "isolated cell", ( = 2) "trabeculae cell"
...
% %-------------------------
% ML_Dynamic_Rice_Protocol2_Fig7=[Time_input; Temp_input; KSE_input; SLo_input; Ca_input; F_active_output; F_total_output; SL_output];
% csvwrite('ML_Dynm_Rice_Protocol2_Fig7.csv',ML_Dynamic_Rice_Protocol2_Fig7)
% %------------------------------

%------------------------------------------------
% Export Protocol2, Test#1 @ Temp= 22.5, vary KSE=1 & Camax = 1.45 SL=2.2
%------------------------------------------------
ML_Dynamic_Rice_Protocol2_Test1_Fig7AB=[Time_input; Temp_input; KSE_input; SLo_input; Ca_input; F_active_output; F_total_output; SL_output];
csvwrite('ML_Dynm_Rice_Protocol2_Test1_Fig7AB.csv',ML_Dynamic_Rice_Protocol2_Test1_Fig7AB)
%------------------------------

% %------------------------------------------------
% % Export Protocol2 Test#2 @ Temp= 22.5, KSE=1 & SL = 2.2 
% %------------------------------------------------
% ML_Dynamic_Rice_Protocol2_Test2_Fig7B=[Time_input; Temp_input; KSE_input; SLo_input; Ca_input; F_active_output; F_total_output; SL_output];
